...
- The scripting language used is [Lape](https://github.com/nielsAD/lape) which uses a Pascal-like syntax.<br>
- Documentation for Simba is available [here](https://villavu.github.io/Simba/index.html).

<p align="center">
<img src="Images/readme/simba_ide.png" width=66% height=66%>
<img src="Images/readme/aca.gif" width=66% height=66%>
</p>
