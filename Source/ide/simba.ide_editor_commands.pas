unit simba.ide_editor_commands;
...
uses
  Classes, SysUtils, SynEditKeyCmds;
...
begin
  ...
  AddKey(ecCodeComplete, VK_RETURN, [ssCtrl]);
  AddKey(ecParamHint, VK_SPACE, [ssCtrl, ssShift]);
  AddKey(ecCompletionBox, VK_SPACE, [ssCtrl]);
  AddKey(ecCommentSelection, VK_LCL_SLASH, [ssCtrl]);
  AddKey(ecDocumentation, VK_D, [ssCtrl]);
end;
