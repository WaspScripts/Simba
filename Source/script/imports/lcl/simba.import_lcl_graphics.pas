...
begin
  ...
  begin
    ...
    addClass('TLazFont', 'TLazGraphicsObject', TFont);
    ...
    addClass('TLazPen', 'TLazGraphicsObject', TPen);
    ...
    addClass('TLazBrush', 'TLazGraphicsObject', TBrush);
    ...
    addClass('TLazBitmap', 'TLazGraphic', TBitmap);
